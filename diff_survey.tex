...
worse task performance\cite{HighlightingInterventions}.

Both of these studies had administered questions under the same task taxonomy.
This taxonomy characterized these questions as "low level" forms of information
extraction, which belonged to classes such as "Retrieve Value", "Compute Derived
Value", and "Sort"\cite{Amar}. A 2014 study on cognitive abilities in the context
of user layout 
...
% Spatial Ability
% Chen: Spatial ability and visual navigation: an empirical study
% Velez at el.: Understanding Visualization through Spatial Ability Differences
% Openness
