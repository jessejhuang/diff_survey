...
Fifty seven visualization papers have been surveyed, and thirteen of these
papers have been found to directly examine the relationship between visual
analytics interactions and the individual traits enumerated above. 
...
serve as metrics for how "well" an interaction went. Although this encoding enjoys the
benefits of being qualitative and consistent, it is provides a limited view of the
interaction itself. Other methods of measurement include tracking eye movement,
...
% Cognitive abilities (Visual and Verbal working memory, perceptual speed)
% Evaluating the Impact of User Characteristics and Different Layouts on an
%   Interactive Visualization for Decision Making Conati
% Highlighting interventions and user differences: informing adaptive
%      information visualization support Carenini
% There is a clear progression of this research

% Next steps
% based on what we've seen, what are possible future directions?
...
\cite{Ziemkiewicz}.
%problematic- visualization studied do not put participants in situations where they are
% more likely to experience negative emotions, because of ethical concerns
